...
public final class T9Utils {
    ...
    private static final Pool<StringBuilder> STRING_BUILDER_POOL = new Pool<StringBuilder>(4);
    private static final Pool<BitSet> BIT_SET_POOL = new Pool<BitSet>(4);
    ...
    static void recycleStringBuilder( StringBuilder sb) {
        sb.setLength(0);
    ...
    static void recycleBitSet( BitSet bs) {
        bs.clear();
     ...
     */
    public static boolean isValidT9Key( CharSequence key) {
    ...
    @Deprecated
    public static String buildT9Key( List<PinyinToken> pinyinTokens) {
        StringBuilder pinyinBuilder = getReusableStringBuilder();
    ...
    private static void insertT9Key( StringBuilder t9KeyBuilder,  String t9Str) {
        if (t9Str.length() == 0)
            return;
    ...
    public static String buildT9Key( String src,  PinyinProvider provider) {
        StringBuilder t9KeyBuilder = getReusableStringBuilder();
