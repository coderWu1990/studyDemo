...
import com.wd.demo.t9search.lib.PinyinProvider;
import com.wd.demo.t9search.lib.T9MatchInfo;
import com.wd.demo.t9search.lib.T9Matcher;
import com.wd.demo.t9search.lib.T9Utils;
...
public final class T9SearchSupport {
    ...
    static {
        ...
        SET_POOL = new Pools.SynchronizedPool<Set<String>>(4);
