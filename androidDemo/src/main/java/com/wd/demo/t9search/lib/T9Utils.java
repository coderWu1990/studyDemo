package com.wd.demo.t9search.lib;
            ...
            if (/*ASCII*/c < 128 ||/*Extended Latin*/(c < 0x250 || (0x1e00 <= c && c < 0x1eff))) {
                ...
                if (pinyin == null || pinyin.length == 0) {
                    ...
                    for (String py : pinyin) {
                        ...
                        Log.i("wd", "tempBuilder=" + tempBuilder);
