package com.wd.demo.widget.water;
...
public class WaterView extends FrameLayout {
     ...
     * x坐标当前可选的随机数组
     */
    private List<Float> mXCurrentCanShoseRandoms = new ArrayList<Float>();
    /**
     * y坐标当前可选的随机数组
     */
    private List<Float> mYCurrentCanShoseRandoms = new ArrayList<Float>();

    /**
     * 已经选取x的随机数值
     */
    private List<Float> mXRandoms = new ArrayList<Float>();
    /**
     * 已经选取y的随机数值
     */
    private List<Float> mYRandoms = new ArrayList<Float>();
    ...
    private void addWaterView(List<Water> waters) {
        for (int i = 0; i < waters.size(); i++) {
            ...
            TextView tvWater = (TextView) view.findViewById(R.id.tv_water);
            view.setTag(water);
